<!--
  ...
  迁移适配：
  1. import 路径由 @/utils/workflow/constantBtn 调整为 @/views/workflow/utils/workflow/constantBtn
  作用：控制审批节点中【审批页面】按钮的显示权限；默认按钮（type=default）
       固定选中不可取消；勾选结果通过 update:modelValue 回写父组件表单。
-->
<template>
...
import { approvalPageButtons } from "@/views/workflow/utils/workflow/constantBtn";

/** 父级传入的按钮权限配置 { approvalPage: [] } */
