<!--
  ...
  作用：编辑审批人节点配置：审批人类型（指定成员/角色/直属领导/发起人自己/指定层级/
       层层审批/发起人自选）、多人审批方式（或签/会签/顺序会签）、审批人为空处理、
       按钮权限与表单字段权限；提交后写回 store 中的 approverConfig（含显示名与
       校验错误标记）。人员/角色通过 selectUserDialog/selectRoleDialog 选择。
-->
<template>
...
/**审批人设置验证：指定成员/角色必须至少选择一项，指定层级必须选择有效层级 */
