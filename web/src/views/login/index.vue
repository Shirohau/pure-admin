...
import { thirdLogin } from "@/views/oauth2";
...
const ruleForm = reactive({
  // 演示项目：无条件默认填入演示账号，访客打开登录页即可直接体验；输入框仍可编辑/清空
  username: "superadmin",
          ...
          <Motion v-if="currentPage === 0" :delay="350">
            <el-form-item>
              ...
              <div class="w-full flex justify-evenly">
                ...
                >
                  <IconifyIconOnline
                    class="cursor-pointer inline-block transition-transform duration-200 hover:scale-125"
                    :icon="`${item.icon}`"
                    width="20"
                    :style="{ color: item.color }"
                    @click="thirdLogin(item, 'login')"
                  />
                </span>
              </div>
            </el-form-item>
